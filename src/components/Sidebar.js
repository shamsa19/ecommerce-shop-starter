...
const Sidebar = () =>{
 ...
 py-6 border-b  ">
  ...
  className="cursor-pointer x-8 h-8 flex
  justify-center items-center">
    <IoMdArrowForward className="text-2xl"/>
  </div>
 </div>
 <div  className="flex flex-col gap-y-2
 h-[520px] lg:h-[640px] overlflow-y-auto 
 ...
 <Link to='/' 
   ...
   justify-center items-center text-primary w-full 
   font-medium">View cart</Link>
 <Link to='/' 
    className=" bg-primary flex p-4
    justify-center items-center text-white w-full 
